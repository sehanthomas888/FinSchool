...
`,
  ...
  quiz: [
    ...
    { k: 'concept', q: 'What is an expense ratio?', o: ['The yearly fee charged as a percentage of the money invested', 'A tax on investment gains', 'A trading commission per share', 'The fund\'s yearly return'], a: 0, why: 'It is taken from the fund\'s assets automatically every year, whether the fund goes up or down.' }
  ],
