...
`,
  ...
  quiz: [
    ...
    { k: 'concept', q: 'What does the equity multiplier measure?', o: ['Total assets divided by equity: how much of the balance sheet is funded by borrowing (leverage)', 'Sales per dollar of assets', 'Profit per dollar of sales', 'Dividends per share'], a: 0, why: 'A multiplier of 2 means half the assets are funded by debt. It is the leverage term in DuPont.' }
  ],
...
`,
  ...
  quiz: [
    ...
    { k: 'concept', q: 'How does capitalizing a cost (rather than expensing it) affect current-year profit?', o: ['It raises current profit, because the cost is spread over future years', 'It lowers current profit', 'It has no effect on profit', 'It creates cash'], a: 0, why: 'A capitalized cost goes on the balance sheet and is expensed gradually. Expensing deducts all of it now.' }
  ],
